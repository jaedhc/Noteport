...
class RRActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rellenar_reporte)
        ...
        btnEnviar.setOnClickListener{
            ...
            val servicio = "Servicio Limpieza"
